...
def login_page():
    ...
    if form.validate_on_submit():
        ...
        if attempted_user and attempted_user.check_password_correction(attempted_password=form.password.data):
            ...
            flash(f'Login was successful {attempted_user.username}', category='success')
            return redirect(url_for('market_page'))
        else:
            flash(f'Invalid username or password! Please enter correct username and password', category='danger')
